...
# check the consistency of an assignment to a bn.fit.dnode or a bn.fit.onode.
...
# check an assignment against the bn.fit.dnode or bn.fit.onode it will be
# assigned to.
...
}#CHECK.RVALUE.VS.DNODE

# check an assignment to a bn.fit.dnode or a bn.fit.onode against the local
...
}#CHECK.DNODE.RVALUE.VS.PARENTS

# check the consistency of an assignment to a bn.fit.gnode.
...
# check an assignment against the bn.fit.gnode it will be assigned to.
...
}#CHECK.RVALUE.VS.GNODE

# check an assignment to a bn.fit.gnode using only the names of its parents.
...
}#CHECK.GNODE.RVALUE.VS.PARENTS

# check the consistency of an assignment to a bn.fit.cgnode.
...
# check an assignment against the bn.fit.cgnode it will be assigned to.
...
}#CHECK.RVALUE.VS.CGNODE

# check an assignment to a bn.fit.cgnode against the local distributions of its
# parents.
...
}#CHECK.CGNODE.RVALUE.VS.PARENTS
